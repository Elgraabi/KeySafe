...
export default function LoginScreen() {
    ...
    const handleLogin = async (values: { username: string; password: string; keepConnected: boolean }) => {
        try {
                    ...
                    <View>
                        ...
                        <View style={styles.checkboxContainer}>
                            <Checkbox
                                ...
                                onValueChange={(newValue) => setFieldValue("keepConnected", newValue)}
                            />
                            <Text style={styles.label}>Manter conectado</Text>
                        </View>

                        <View style={styles.boxButto}>
                            <Button title="Entrar" className="enter" onPress={() => handleSubmit()} />
                            <Button
